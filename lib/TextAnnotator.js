...
var TextAnnotator = function (props) {
    ...
    var content = props.content, value = props.value, style = props.style, divProps = __rest(props, ["content", "value", "style"]);
    var splits = utils_1.splitWithOffsets(content, value);
    return (react_1["default"].createElement("div", __assign({}, divProps, { style: style, onMouseUp: handleMouseUp }), splits.map(function (split) { return (react_1["default"].createElement(Split, __assign({ key: split.start + "-" + split.end }, split, { onClick: handleSplitClick }))); })));
};
